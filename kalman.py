...
class ProcessImage:
    ...
    def DetectBall(self, frame):
        ...
        lowerBound = np.array([161,100,84], dtype = "uint8")
        upperBound = np.array([179,255,255] , dtype = "uint8")
        ...
        [nLabels, labels, stats, centroids] = cv.connectedComponentsWithStats(greenMask, 8, cv.CV_32S)
